package com.appsdevelopr.PhotoApps.apiusers;
...
import com.appsdevelopr.PhotoApps.apiusers.shared.FeignErrorDecoder;
...
public class PhotoAppsApiUsersApplication {

	@Autowired
	Environment environment;
	
	public static void main(String[] args) {
		SpringApplication.run(PhotoAppsApiUsersApplication.class, args);
	}
